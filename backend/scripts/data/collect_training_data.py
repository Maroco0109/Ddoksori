...
class DataCollector:
    INSTRUCTION_QUERY_TYPE = "Classify the user query into 'dispute', 'general', 'law', 'system'."
    ...
    def extract_query_analysis(self, log_data: dict[str, Any]) -> Optional[dict[str, Any]]:
    ...
    def generate_training_examples(self, qa_data: dict[str, Any]) -> list[TrainingExample]:
