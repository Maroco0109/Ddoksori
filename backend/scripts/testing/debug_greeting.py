...
from app.agents.answer_generation.agent import _build_general_response, _try_early_exit
...
async def debugers_greeting():
    ...
    for query in test_queries:
        ...
        print(f"[Classifier] Type: {intent_result.query_type}, Confidence: {intent_result.confidence}")
        ...
        response_text = early_exit_result.get('draft_answer') if early_exit_result else None
