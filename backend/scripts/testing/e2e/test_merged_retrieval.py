...
class TestRetrievalAgentImports:
    ...
    def test_law_agent_importable(self):
        ...
        from app.agents.retrieval.law_agent import LawRetrievalAgent, law_retrieval_agent
    ...
    def test_criteria_agent_importable(self):
        ...
        from app.agents.retrieval.criteria_agent import CriteriaRetrievalAgent, criteria_retrieval_agent
    ...
    def test_case_agent_importable(self):
        ...
        from app.agents.retrieval.case_agent import CaseRetrievalAgent, case_retrieval_agent
    ...
    def test_counsel_agent_importable(self):
        ...
        from app.agents.retrieval.counsel_agent import CounselRetrievalAgent, counsel_retrieval_agent
        ...
        for agent in all_agents:
            for attr in required_attrs:
                ...
                assert value is not None, \
                    f"{agent.__class__.__name__}.{attr} is None"
                assert value != "", \
                    f"{agent.__class__.__name__}.{attr} is empty"
...
class TestClassVarAttributes:
    ...
    def test_required_inputs_defined(self):
        ...
        agent_classes = [LawRetrievalAgent, CriteriaRetrievalAgent, CaseRetrievalAgent, CounselRetrievalAgent]
