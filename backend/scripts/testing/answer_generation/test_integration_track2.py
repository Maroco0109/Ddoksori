...
@patch(
    "app.agents.answer_generation.agent.AnswerGenerationFallback.generate_with_fallback"
)
def test_track2_followup_questions_enabled(mock_fallback, mock_config):
    ...
    # Mock fallback
    mock_fallback.return_value = ("환불은 14일 이내에 가능합니다.", "gpt-4o-mini", [])
...
def test_track2_with_missing_fields(mock_fallback, mock_config):
    ...
    # Mock fallback
    mock_fallback.return_value = ("추가 정보가 필요합니다.", "gpt-4o-mini", [])
