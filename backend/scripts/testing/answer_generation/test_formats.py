...
def test_prompt_builder_user_prompt():
    ...
    context = {'has_cases': True, 'has_laws': False, 'has_criteria': False, 'has_agency': True}
...
def test_format_selection_and_prompt_building_integration():
    ...
    query_analysis = {'query_type': 'dispute'}
    retrieval = {
        'disputes': [{'doc_id': '123', 'doc_title': '사례1', 'source_org': 'KCA',
                      'decision_date': '2024-01-01', 'similarity': 0.85, 'content': '내용'}],
        'counsels': [],
        'laws': [],
        'criteria': []
    }
