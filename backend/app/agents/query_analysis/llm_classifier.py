...
FEW_SHOT_EXAMPLES = [
    {"query": "안녕", "type": "general", "confidence": 0.95, "reasoning": "인사말 = 일반 대화"},
    {"query": "ㅎㅇ", "type": "general", "confidence": 0.95, "reasoning": "인사말 약어 = 일반 대화"},
    {"query": "노트북 파손되었는데 환불 가능해?", "type": "dispute", "confidence": 0.95, "reasoning": "제품 파손 + 환불 요청 = 소비자 분쟁"},
    {"query": "노트북 관련 기준 있어?", "type": "criteria", "confidence": 0.90, "reasoning": "제품 + 기준 요청 = 분쟁해결기준 검색"},
    {"query": "소비자보호법이 뭐야?", "type": "general", "confidence": 0.90, "reasoning": "정의형 질문, 구체적 분쟁 없음"},
    {"query": "오늘 날씨 어때?", "type": "general", "confidence": 0.95, "reasoning": "소비자 분쟁과 무관한 일반 대화"},
    {"query": "헬스장 3개월 등록했는데 환불해줘", "type": "dispute", "confidence": 0.95, "reasoning": "서비스 계약 + 환불 요청"},
    {"query": "청약철회 기간이 어떻게 되나요?", "type": "law", "confidence": 0.85, "reasoning": "법적 기간 정보 요청"},
    {"query": "전자상거래법 제17조가 뭐야?", "type": "law", "confidence": 0.95, "reasoning": "특정 법조항 정보 요청"},
    {"query": "분쟁해결기준에서 노트북 환불 기준 알려줘", "type": "criteria", "confidence": 0.90, "reasoning": "분쟁해결기준 참조"},
    {"query": "금융 분쟁 어떻게 해결하나요?", "type": "restricted", "confidence": 0.85, "reasoning": "금융 도메인 = 전문기관 필요"},
]
...
- general: 일반 대화, 인사, 정의형 질문
- law: 법령/법조항 정보 요청
- criteria: 분쟁해결기준 정보 요청
- procedure: 절차/방법 질문
- restricted: 전문기관 도메인 (금융, 의료, 개인정보, 부동산, 건설)
- system_meta: 시스템/봇 관련 질문
- ambiguous: 분류 불가능
