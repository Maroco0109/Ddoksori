        ...
        try:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "당신은 사용자의 질문을 법령 용어로 꾸며서 내뱉는 답안기입니다. 법률에 대해 유사도 검색이 잘 수행될 수 있도록 다음의 문장을 바꾸세요. 단, '판결문'이 아닌 '법률'입니다. 문장:",
                    },
            ...
            logger.warning(
                "[LawRetrievalAgent] OpenAI package not installed, skip LLM rewrite"
            )
